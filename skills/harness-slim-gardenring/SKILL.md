...
description: >-
  Find and remove AI slop and recurring repository drift in small, verified
  batches. Use when agent-generated code has accumulated duplicated helpers,
  speculative abstractions, stale docs, guessed data shapes, dead artifacts,
  inconsistent patterns, or low-signal boilerplate; or when running periodic
  code gardening and turning repeated cleanup lessons into enforceable rules.
---
...
- Code, tests, and maintained documentation contradict a stale artifact.
...
5. Remove residue created by the cleanup: imports, comments, tests, configuration, and dependencies that are now truly unused.
